...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("integrationconfiguration");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("integrationconfiguration");
        ...
        config.getMapConfigs().put("io.igia.integration.configuration.domain.*", initializeDomainMapConfig(jHipsterProperties));
