...
/**
 * A DTO for the {@link io.igia.integration.configuration.domain.Filter} entity.
 */
public class FilterDTO implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8697281504486304302L;
	...
	public String toString() {
		return "FilterDTO [id=" + id + ", order=" + order + ", type=" + type + ", data=" + data + ", description="
