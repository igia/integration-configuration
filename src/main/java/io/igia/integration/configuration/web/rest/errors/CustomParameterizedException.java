...
public class CustomParameterizedException extends AbstractThrowableProblem {
    ...
    public CustomParameterizedException(String message,String title, Map<String, Object> paramMap) {
        super(ErrorConstants.PARAMETERIZED_TYPE, title, BAD_REQUEST, null, null, null, toProblemParameters(message, paramMap));
    }
