...
public interface EndpointMetadataRepository extends JpaRepository<EndpointMetadata, Long> {
    ...
    List<EndpointMetadata> findAllByTypeAndCategoryAndIsMandatory(String type, String category, boolean isMandatory);

    List<EndpointMetadata> findAllByTypeAndCategoryAndIsEncrypted(String type, String category, boolean isEncrypted);
