...
Scenario: Create MLLP to FILE data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        * def reqCreate =  read('classpath:integration/data-pipeline/mllp/create-request-mllp-file-deploy-with-FT.json')
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/mllp/create-response-mllp-file-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/mllp/create-response-mllp-file-deploy-with-FT.json')
    ...
    * def resExport = read('classpath:integration/data-pipeline/common/export-response-not-found.json')
    Given path '/interfaces/' + pipelineId + '/export'
        And header Authorization = 'Bearer ' + accessToken
        When method get
        Then status 400
...
@TestMLLP
 Scenario: Create MLLP to SFTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/mllp/create-request-mllp-sftp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/mllp/create-response-mllp-sftp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/mllp/create-response-mllp-sftp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestMLLP
 Scenario: Create MLLP to HTTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/mllp/create-request-mllp-http-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/mllp/create-response-mllp-http-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/mllp/create-response-mllp-http-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestMLLP
 Scenario: Create MLLP to HTTPS data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/mllp/create-request-mllp-https-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/mllp/create-response-mllp-https-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/mllp/create-response-mllp-https-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestMLLP
 Scenario: Create MLLP to MLLP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/mllp/create-request-mllp-mllp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/mllp/create-response-mllp-mllp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/mllp/create-response-mllp-mllp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
