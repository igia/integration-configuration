...
@TestHTTP
 Scenario: Create HTTPS to FILE data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-file-deploy-with-FT.json')
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/http/create-response-https-file-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/http/create-response-https-file-deploy-with-FT.json')
...
@TestHTTP
 Scenario: Create HTTPS to HTTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-http-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/http/create-response-https-http-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/http/create-response-https-http-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestHTTP
 Scenario: Create HTTPS to HTTP data pipeline fails that has isSecure property missing
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-http-deploy-with-missing-property.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * set reqCreate.destinations[0].configurations[1].value = httpConfigs.outputPort
        * set reqCreate.destinations[0].configurations[2].value = httpConfigs.outputUri
        * def resCreate =  read('classpath:integration/data-pipeline/http/missing-property.json')
...
@TestHTTP
 Scenario: Create HTTPS to HTTP data pipeline fails that has isSecure property invalid in the source configuration
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-http-deploy-with-isSecure-false.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * set reqCreate.destinations[0].configurations[1].value = httpConfigs.outputPort
        * set reqCreate.destinations[0].configurations[2].value = httpConfigs.outputUri
        * def resCreate =  read('classpath:integration/data-pipeline/http/invalid-isSecure-value.json')
 ...
 * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-https-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/http/create-response-https-https-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/http/create-response-https-https-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestHTTP
 Scenario: Create HTTPS to SFTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-sftp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/http/create-response-https-sftp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/http/create-response-https-sftp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestHTTP
 Scenario: Create HTTPS to MLLP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/http/create-request-https-mllp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/http/create-response-https-mllp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/http/create-response-https-mllp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
