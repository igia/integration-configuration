...
@TestFILE
 Scenario: Create FILE to MLLP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
         * def reqCreate =  read('classpath:integration/data-pipeline/file/create-request-file-mllp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/file/create-response-file-mllp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/file/create-response-file-mllp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestFILE
 Scenario: Create FILE to HTTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
         * def reqCreate =  read('classpath:integration/data-pipeline/file/create-request-file-http-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/file/create-response-file-http-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/file/create-response-file-http-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestFILE
 Scenario: Create FILE to HTTPS data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
         * def reqCreate =  read('classpath:integration/data-pipeline/file/create-request-file-https-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/file/create-response-file-https-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/file/create-response-file-https-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
...
@TestFILE
 Scenario: Create FILE to SFTP data pipeline that is deployed and it has 2 filters and 2 transformers and get data pipeline resources and delete the pipeline and get that pipeline again.
        ...
        * def reqCreate =  read('classpath:integration/data-pipeline/file/create-request-file-sftp-deploy-with-FT.json')
        * set reqCreate.name = "Test-" + now()
        * set reqCreate.source.name = "Source-" + now()
        * set reqCreate.destinations[0].name = "Destination-" + now()
        ...
        * def tempJSON = read('classpath:integration/data-pipeline/file/create-response-file-sftp-deploy-with-FT.json')
        * def resCreate = read('classpath:integration/data-pipeline/file/create-response-file-sftp-deploy-with-FT.json')
        * def resDeleteNotFound = read('classpath:integration/data-pipeline/common/delete-response-not-found.json')
        * def resGetByIdNotFound = read('classpath:integration/data-pipeline/common/get-response-not-found.json')
