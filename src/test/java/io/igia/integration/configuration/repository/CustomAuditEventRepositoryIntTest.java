...
import io.igia.integration.configuration.config.audit.AuditEventConverter;
import io.igia.integration.configuration.domain.PersistentAuditEvent;
import io.igia.integration.configuration.repository.CustomAuditEventRepository;
import io.igia.integration.configuration.repository.PersistenceAuditEventRepository;
...
import static io.igia.integration.configuration.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
